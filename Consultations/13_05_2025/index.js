...
// Создается пустой массив persons, в котором будут храниться
//  данные о людях, которые будут добавляться через форму.
...
formElement.addEventListener("submit", (event) => {
  ...
  // устанавливается обработчик клика onclick, который вызывает функцию
  //  changeStatus для изменения стиля элемента при клике.
